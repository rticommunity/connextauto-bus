...
``MICRO`` (optional)
    Generate the source code for micro

``NAMESPACE`` (optional)
    Generate the source code using namespaces
...
macro(_connextdds_codegen_find_codegen use_codegen1)
    ...
    if(RTICODEGENMICRO_DIR)
        set(RTICODEGEN_DIR ${RTICODEGENMICRO_DIR})
    endif()
...
function(connextdds_rtiddsgen_run)
    set(options
        ...
        STANDALONE USE_CODEGEN1 DEBUG NO_CODE_GENERATION GENERATE_EXAMPLE MICRO NAMESPACE
    )
